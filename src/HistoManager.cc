...
void HistoManager::Book()
{
  ...
  // Add netron source histo
  G4int ihis = analysisManager->CreateH3("Nsource", "Neutron source", 100,-5.,5., 100,-5.,5., 100,-5.,5.);
  analysisManager->SetH3Activation(ihis, true);
  ...
  analysisManager->CreateNtupleDColumn("fEkin");
  analysisManager->CreateNtupleDColumn("fCharge");
  analysisManager->CreateNtupleDColumn("fMass");
  analysisManager->CreateNtupleSColumn("fName");
  analysisManager->CreateNtupleDColumn("fHitX"); // position of the cell
  analysisManager->CreateNtupleDColumn("fHitY");
  analysisManager->CreateNtupleDColumn("fHitZ");
  analysisManager->CreateNtupleDColumn("fHitT");
  analysisManager->CreateNtupleDColumn("fVrtxZ");
